...
<html lang="en">
  ...
  <head>
    ...
    <title>BiblioBound</title>

    <!-- Bootstrap core CSS -->
    <link href="templatefront/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">


    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="/templatefront/assets/css/fontawesome.css">
    <link rel="stylesheet" href="/templatefront/assets/css/templatemo-scholar.css">
    <link rel="stylesheet" href="/templatefront/assets/css/owl.css">
    <link rel="stylesheet" href="/templatefront/assets/css/animate.css">
...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li class="scroll-to-section"><a href="#services">Mission</a></li>
                      ...
                      <a href="/register" class="btn btn-primary btn-user btn-block"> Register Account</a>
                        <a href="/login" class="btn btn-secondary btn-user btn-block"> Register Account</a> -->
                  </ul>   
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="templatefront/assets/images/service-01.png" alt="online degrees">
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="templatefront/assets/images/service-02.png" alt="short courses">
            </div>
            <div class="main-content">
              <h4>Short Courses</h4>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="templatefront/assets/images/service-03.png" alt="web experts">
            </div>
            <div class="main-content">
              <h4>Web Experts</h4>
      ...
      <div class="row event_box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="templatefront/assets/images/course-01.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="templatefront/assets/images/course-02.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="templatefront/assets/images/course-03.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="templatefront/assets/images/course-04.jpg" alt=""></a>
              <span class="category">Development</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="templatefront/assets/images/course-05.jpg" alt=""></a>
              <span class="category">Wordpress</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="templatefront/assets/images/course-06.jpg" alt=""></a>
              <span class="category">Webdesign</span>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="templatefront/assets/images/member-01.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="templatefront/assets/images/member-02.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="templatefront/assets/images/member-03.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="templatefront/assets/images/member-04.jpg" alt="">
        ...
        <div class="col-lg-7">
          <div class="owl-carousel owl-testimonials">
            <div class="item">
              ...
              <div class="author">
                <img src="templatefront/assets/images/testimonial-author.jpg" alt="">
                <span class="category">Full Stack Master</span>
                <h4>Claude David</h4>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="templatefront/assets/images/event-01.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="templatefront/assets/images/event-02.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="templatefront/assets/images/event-03.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
  ...
  <script src="templatefront/vendor/jquery/jquery.min.js"></script>
  <script src="templatefront/vendor/bootstrap/js/bootstrap.min.js"></script>
  <script src="templatefront/assets/js/isotope.min.js"></script>
  <script src="templatefront/assets/js/owl-carousel.js"></script>
  <script src="templatefront/assets/js/counter.js"></script>
  <script src="templatefront/assets/js/custom.js"></script>
